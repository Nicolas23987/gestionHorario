...
export function WeekInfo(id_materia) {
                ...
                <div className="container-list">
                    <div className="dv-container-week">
                        <div className="dv-container-selec">
                            <button className="">
                                <Link to='/materia/docente' id_materia={id_materia} >
                            ...
                            <button
                            >
                                <Link to="/materia/estudiantes" state={id_materia}>
                                    <div className="container-icon">
                        ...
                        <div className="div-center dv-start" style={{ display: isVisible ? 'none' : 'block' }}>
