...
const {get_Horarios,update_Horario,delete_Horario,create_Horario, get_Horario, get_HorarioDocente} = require('../controlles/horario_controlle.js');
...
horario_router.get('/get/horario/docente/:id',get_HorarioDocente);
