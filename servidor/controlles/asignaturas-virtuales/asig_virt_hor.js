...
const {AsignaturaVirtuales_Horario} = require('../../relaciones/relaciones.js');
...
const getHorarioAsignaturaV = async(req, res) => {
    const id_materia = req.params.id
    console.log(id_materia)
    try{
        const asignaturaAlumnos = await AsignaturaVirtuales_Horario.findAll({
            where: {
